...
time_start = Sys.time()
bc_obj_umi = bc_extract(f_v1, pattern1, sample_name = c("rep1", "rep2"), pattern_type = c(barcode = 2, UMI = 1), maxLDist = 1)
Sys.time() - time_start

time_start = Sys.time()
bc_obj_noumi = bc_extract(f_v2, pattern2, sample_name = c("rep1", "rep2"), maxLDist = 1)
Sys.time() - time_start
...
bc_plot_mutual(bc_obj_noumi, count_marks = c(700, 880))
