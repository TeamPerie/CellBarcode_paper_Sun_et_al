...
# NOTE: input
d = fread("./tmp/table_no_umi_p00001_threshold_predict_rate_depth.tsv")
...
#' ## Merge threshold
# d1 = fread("./tmp/table_no_umi_auto_threshold_predict_rate_depth.tsv")[, resolution := "auto"]
# d2 = fread("./tmp/table_no_umi_p01_threshold_predict_rate_depth.tsv")[, resolution := "0.01"]
d3 = fread("./tmp/table_no_umi_p001_threshold_predict_rate_depth.tsv")[, resolution := "0.001"]
d4 = fread("./tmp/table_no_umi_p0001_threshold_predict_rate_depth.tsv")[, resolution := "0.0001"]
