...
transcripted and thus detected by scRNASeq. There is another vignette, which is about bulk sample barcode analysis, will be very helpful, highly recommend reading that in addition to this one.
...
It is a 10X Genomics scRNASeq data with a paired-end sequencing. 
