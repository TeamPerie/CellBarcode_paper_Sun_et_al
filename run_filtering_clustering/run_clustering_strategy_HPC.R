...
# NOTE: output
pdf("./tmp/fig_no_umi_simple_ROC_clustering.pdf")
...
# NOTE: output
write_tsv(d_count_true_barcode, "./tmp/table_count_true_barcode_clustering.tsv")
...
# NOTE: output
write_tsv(d_auc, "./tmp/table_auc_no_umi_clustering.tsv")
...
#+ eval=F
# NOTE: output
pdf("./tmp/fig_auto_cutoff_point_clustering.pdf")
...
write_tsv(d, "./tmp/table_no_umi_auto_threshold_predict_rate_clustering.tsv")
...
#+ eval=F
# NOTE: output
pdf("./tmp/fig_p0001_cutoff_point_clustering.pdf")
# for (i in seq_along(x_cutoff)[grep("seq_7", names(x_cutoff))]) {
...
write_tsv(d, "./tmp/table_no_umi_p0001_threshold_predict_rate_clustering.tsv")
...
#+ eval=F
# NOTE: output
pdf("./tmp/fig_p00001_cutoff_point_clustering.pdf")
# for (i in seq_along(x_cutoff)[grep("seq_7", names(x_cutoff))]) {
for (i in seq_along(x_cutoff)[1:26]) {
    simu_name = bc_names(bc_obj2)[i]
    ## draw the barcode filtering figures
...
write_tsv(d, "./tmp/table_no_umi_p00001_threshold_predict_rate_clustering.tsv")
